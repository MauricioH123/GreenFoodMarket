...
class ClienteDAO{
    ...
    public function editarClientes($id_cliente, $nombre, $numero_celular, $correo, $direccion){
        $id_cliente = ucwords(strtolower($this -> sanitizeMysql($this ->conn,$id_cliente)));
        $nombre = ucwords(strtolower($this -> sanitizeMysql($this ->conn,$nombre)));
        $numero_celular = ucwords(strtolower($this -> sanitizeMysql($this ->conn,$numero_celular)));
        $correo = strtolower(strtolower($this -> sanitizeMysql($this ->conn,$correo)));
        $direccion = ucwords(strtolower($this -> sanitizeMysql($this ->conn,$direccion)));
        try{
