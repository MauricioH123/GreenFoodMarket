        ...
        <div class="container">
            ...
            <form action="index.php?action=entradaC" method="post">
                <div class="row">
                    ...
                    <div class="col">
                    <label for="numeroFactura" class="form-label">Cantidad</label>
                    <input type="number" disabled dstep="0.01" id="numeroFactura" name="numero_factura" class="form-control" required value="1">
                    </div>

                    <div class="col">
                    <label for="nombreCliente" class="form-label">Nombre del Cliente</label>
                    <select class="form-select" name="nombre_cliente" aria-label="Default select example" required>
